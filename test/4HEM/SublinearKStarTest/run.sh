...
#java -Xmx64g -Xss20g edu/duke/cs/osprey/tests/SublinearKStarTests -c KStar.cfg variationalSublinear DEE.cfg System.cfg
java -Xmx64g -Xss20g edu/duke/cs/osprey/control/Main -c KStar.cfg variationalSublinear DEE.cfg System.cfg
