...
java -Xmx64g -Xss20g edu/duke/cs/osprey/tests/variationalkstar/SublinearFreeEnergyTests -c KStar.cfg noCommand DEE.cfg System.cfg
#java -Xmx64g -Xss20g edu/duke/cs/osprey/tests/variationalkstar/SublinearFreeEnergyTests -c KStar.cfg doExhaustive DEE.cfg System.cfg
