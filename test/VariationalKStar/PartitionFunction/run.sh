...
# Run the large test/profiling suite
java -Xmx64g -Xss20g edu/duke/cs/osprey/tests/variationalkstar/VariationalPartFuncTests -c KStar.cfg large DEE.cfg System.cfg

# Run the smaller test suite
#java -Xmx64g -Xss20g edu/duke/cs/osprey/tests/variationalkstar/VariationalPartFuncTests -c KStar.cfg small DEE.cfg System.cfg
