...
print("mols is type " + str(type(mols)))
print("kCAL01 is type " + str(type(kCAL01)))

# # Conformation Space Preparation Step 2: define WT "mutations" (the minimum flexible set)
