...
/**
 * SHARKStar extends MARK* to precompute tighter ensemble bounds on flexible
 * residues, and reuse previously computed AA information.
 */
public class SHARKStar {
	...
	public class SequenceInfo {
		...
		public SequenceInfo(SeqAStarNode node, SeqConfs confs) {
			...
			objective = SHARKStar.this.objective.calc(confs);
			for (LMFE constraint : SHARKStar.this.constraints) {
	...
	public static class Builder {
		...
		public SHARKStar build() {
			SHARKStar mskStar = new SHARKStar(objective, constraints, epsilon, objectiveWindowSize, objectiveWindowMax, maxSimultaneousMutations, minNumConfTrees, printToConsole, logFile);
	...
	private SHARKStar(LMFE objective, List<LMFE> constraints, double epsilon, double objectiveWindowSize, double objectiveWindowMax, int maxSimultaneousMutations, Integer minNumConfTrees, boolean printToConsole, File logFile) {
