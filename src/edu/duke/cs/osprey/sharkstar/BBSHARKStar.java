...
public class BBSHARKStar {
	...
	public class ConfSpaceInfo {
		...
		public PartitionFunction.Result calcPfunc(int sequenceIndex, BigDecimal stabilityThreshold) {
			...
			// compute it
			pfunc.init(null, rcs.getNumConformations(), settings.epsilon);
	...
	public BBSHARKStar(SimpleConfSpace protein, SimpleConfSpace ligand, SimpleConfSpace complex,
	...
	private class SeqHScorer implements SeqAStarScorer {
		...
		public double calc(SeqAStarNode.Assignments assignments) {
			...
			for (SHARKStar.WeightedState wstate : objective.states) {
