...
public class EnergyMatrixCorrector_refactor {
    private final MultiSequenceSHARKStarBound_refactor multiSequenceSHARKStarBound;
    private ConfEnergyCalculator confEcalc;
    private final int maxTupleSize = 3; // having this set at 4 seems to be too aggressive

    public EnergyMatrixCorrector_refactor(MultiSequenceSHARKStarBound_refactor multiSequenceSHARKStarBound) {
    ...
    void computeEnergyCorrection(ConfAnalyzer.ConfAnalysis analysis, ConfSearch.ScoredConf conf,
        ...
        // storePartialConfCorrections(conf, epsilonBound, diff, sortedPairwiseTerms2, threshhold, minDifference, triplethreshhold);
            storePartialConfCorrections(conf, epsilonBound, diff, sortedPairwiseTerms2, threshhold, minDifference, triplethreshhold,
                    maxTupleSize, scheduledMinimizations);
