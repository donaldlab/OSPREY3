 ...
 */
public class PasteGradientDescentPfunc implements PastePartitionFunction.WithConfTable, PastePartitionFunction.WithExternalMemory {
	...
	public PasteGradientDescentPfunc(ConfEnergyCalculator ecalc) {this.ecalc = ecalc;}
