...
public class Residue implements Serializable {
    ...
    /**
     * PGC2015: saveWTCoords Saves the current coordinates of this residue as
     * the wildtype coordinates.
     */
    ...
    /**
     * PGC 2015: getCurrentRotamerDihedrals Computes the dihedral values for the
     * template that is currently assigned to this type.
     *
