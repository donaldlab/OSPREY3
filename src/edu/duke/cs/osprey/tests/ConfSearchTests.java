...
public class ConfSearchTests {
    ...
    public static void testExhaustive(boolean useTriples){
        //For a small, simple search space, ensure that the ConfSearch object
        //enumerates all conformations in ascending order
        
        SearchProblem searchSpace = makeTestSearchSpace(5,false,true,useTriples);//3^5 confs.  No clashes (would make some weird confs)
        ...
        System.out.println("EXHAUSTIVE CONFORMATIONAL SEARCH TEST PASSED.  useTriples: "+useTriples);
    }
    ...
    public static void testDEE(){
        ...
        SearchProblem searchSpace = makeTestSearchSpace(6/*10*/,true,false,false);
