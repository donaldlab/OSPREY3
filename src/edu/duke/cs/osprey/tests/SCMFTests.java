...
public class SCMFTests {
    ...
    public static void main(String[] args)
        ...
        if (!path.endsWith("4HEM/SCMF_Test")) {
            throw new Error("This profiler was designed to be run in test/4HEM/SCMF_Test folder\n\tcwd: " + path);
        }
        ...
        double correctLogZ = 898.9578799750648;
        ...
        double correctLogZ2 = 894.6048097457233;
