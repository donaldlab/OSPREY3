 ...
 * @author hmn5
 */
public class VariationalKStarTests {

    public static void main(String[] args)
            throws Exception {

        String path = new File("").getAbsolutePath();
        if (!path.endsWith("4HEM/PartFuncTest")) {
            throw new Error("This test was designed to be run in test/4HEM/PartFuncTest folder\n\tcwd: " + path);
        }
        ...
        PartFuncTree tree = new PartFuncTree(searchProb.emat, searchProb.pruneMat, 0.0);
        Stopwatch.start();
