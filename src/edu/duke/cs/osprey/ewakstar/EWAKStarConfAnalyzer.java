...
/**
 *
 * @author lowegard (adapted from ConfAnalyzer.java)
 * gives information on one conformation
 */
public class EWAKStarConfAnalyzer {
    ...
    public class EnsembleAnalysis {
        ...
        public String toString() {
            ...
            for (int i=0; i<analyses.size(); i++) {
                EWAKStarConfAnalyzer.ConfAnalysis analysis = analyses.get(i);
                buf.append("\t");
    ...
    public EWAKStarConfAnalyzer(ConfEnergyCalculator confEcalc, EnergyMatrix emat) {
