...
public class EWAKStarUpperBoundCalculator {
	...
	public EWAKStarUpperBoundCalculator(ConfSearch tree) {
		this.tree = tree;
		this.numUnscoredConfs = tree.getNumConformations();
	}

	public EWAKStarUpperBoundCalculator run(int numConfs) {
	...
	public EWAKStarUpperBoundCalculator run(int numConfs, double epsilon) {
