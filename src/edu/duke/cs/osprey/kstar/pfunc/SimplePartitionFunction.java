...
public class SimplePartitionFunction implements PartitionFunction {
	...
	public SimplePartitionFunction(EnergyMatrix emat, PruningMatrix pmat, ConfSearchFactory confSearchFactory, ConfEnergyCalculator.Async ecalc) {
		this(emat, pmat, confSearchFactory, ecalc, new TaskExecutor());
	}
	
	public SimplePartitionFunction(EnergyMatrix emat, PruningMatrix pmat, ConfSearchFactory confSearchFactory, ConfEnergyCalculator.Async ecalc, TaskExecutor tasks) {
	...
	public void compute(int maxNumConfs) {
		...
		while (status.canContinue() && numConfsEvaluated < stopAtConf) {
