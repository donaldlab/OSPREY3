...
public class ConfSpace implements Serializable {
    ...
    public ConfSpace(String PDBFile, ArrayList<String> flexibleRes, ArrayList<ArrayList<String>> allowedAAs, boolean addWT,
            boolean contSCFlex, DEEPerSettings dset, ArrayList<String[]> moveableStrands, ArrayList<String[]> freeBBZones){
        ...
        for(int pos=0; pos<numPos; pos++){
            ...
            PositionConfSpace rcs = new PositionConfSpace(res, resDOFs, allowedAAs.get(pos), contSCFlex,
                    resStrandDOFs, perts, dset.getPertIntervals(), dset.getPertStates(pos), curBFB);
            posFlex.add(rcs);
        }
