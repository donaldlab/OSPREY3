...
public class SearchProblem implements Serializable {
    ...
    public SearchProblem(String name, String PDBFile, ArrayList<String> flexibleRes, ArrayList<ArrayList<String>> allowedAAs, boolean addWT,
            ...
            boolean addResEntropy, boolean standardizeConformation){
        
        confSpace = new ConfSpace(PDBFile, flexibleRes, allowedAAs, addWT, contSCFlex, dset, moveableStrands, freeBBZones, useEllipses, standardizeConformation);
        this.name = name;
