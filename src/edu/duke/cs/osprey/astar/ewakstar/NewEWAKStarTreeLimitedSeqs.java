...
//
//    public NewEWAKStarTreeLimitedSeqs(EwakstarLimitedSequenceTrie allowedSeqs, int numTreeLevels,
...
//            if(rc==5 && confSpace.positions.get(statePosNum).resConfs.size()<=5){
