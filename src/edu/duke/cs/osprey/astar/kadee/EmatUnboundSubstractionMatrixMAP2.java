...
public class EmatUnboundSubstractionMatrixMAP2 extends EnergyMatrix{
    EnergyMatrix parent;
    ...
    int map_from_parent_res_to_virtual_res_ [][]; // A single parent res corresponds to 1 or more virtual res
    int map_from_parent_rc_to_virtual_rc_ [][]; // Although one parent rc corresponds to a single virtual rc, here it is hierarchizied 

    public EmatUnboundSubstractionMatrixMAP2(EnergyMatrix parent, int num_parent_res, 
    		int num_virtual_residues, int rcs_per_virtual_residue[], 
    		int map_from_virtual_res_to_parent_res [], int map_from_virtual_rc_to_parent_rc[][],
    		int map_from_parent_res_to_virtual_res[][], int map_from_parent_rc_to_virtual_rc[][]) {
        ...
        num_parent_res_ = num_parent_res;
        
        map_from_parent_res_to_virtual_res_ = map_from_parent_res_to_virtual_res;     
        map_from_parent_rc_to_virtual_rc_ = map_from_parent_rc_to_virtual_rc;
    ...
    @Override
    public Double getOneBody(int parent_res, int parent_rc) {
    ...
    @Override
    public Double getPairwise(int _res1, int virtual_rc1, int virtual_res2, int virtual_rc2) {
