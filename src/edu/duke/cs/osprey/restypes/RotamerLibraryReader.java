...
public class RotamerLibraryReader implements Serializable {
    ...
    /**
     *
     * @author pablo BBDepRotamersForTypePhiAndPsi: Backbone Dependent Rotamers
     * For Amino Acid Type given a Phi and Psi angle value. This class is a data
     * structure that stores all the rotamers for a specific phi and psi bin,
     * given an angle.
     */
    private static class BBDepRotamersForTypePhiAndPsi {
        ...
        /**
         * Adds a new rotamer to list of rotamers for this type, phi and psi
         * values.
         *
        ...
        /**
         * Converts the array list rotamersForPhiAndPsi to a 2D array of type
         * double
         *
     ...
     * @author PGC 2015
     *
     * BBDepRotamersForType: Backbone dependent rotamers for type. This class is
     * a data structure that stores all the backbone rotamers for a specific
     * amino acid type. It is used by the Dunbrack parser.
     */
    private static class BBDepRotamersForType {
         ...
         * @param numBins The increments on which the rotamer library classifies
         * rotamers. For Dunbrack this is 10.
         * @param resolution The number of "bins" for each phi and psi. For
         * Dunbrack this is 37 (e.g. at -180, -170, ..., 0, ..., 170, 180)
         */
    ...
    /**
     * PGC 2015: Read all the rotamer entries for the dunbrack rotamer library
     * and add the corresponding ones to the residue templates in the template
     * library templateLib.
     *
    ...
    public static void readDunbrackRotamerLibraryForResiduePosition(String rotFilename, ResidueTemplateLibrary templateLib) {
        ...
        HashMap<String, BBDepRotamersForType> allDunbrackRotamersMap = new HashMap<>();
        for (ResidueTemplate template : templateLib.templates) {
