...
public class CMRF {
	...
	public static void main (String[] args) {
		HashMap<Double, double[]> rets = new HashMap<>();
		runCMRF(18, 0.30, 0);
		runCMRF(18, 0.30, 5);
		runCMRF(18, 0.30, 50);
	}
	...
	public static double[] runCMRF (double size, double kernelMult, int iter) { 
		...
		c.constRT = 1.0;
		c.addNodes(h, map4);
		double logzLB = c.runSCMF();

		double logzUB = c.runTRBP(iter);
